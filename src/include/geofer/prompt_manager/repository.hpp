...
constexpr auto META_PROMPT =
        "You are GeoFer a semantic analysis tool for DBMS. You will analyze each tuple in the provided data and respond "
        "to "
        "the user prompt.\n\nUser Prompt:\n\n- {{USER_PROMPT}}\n\nTuples "
